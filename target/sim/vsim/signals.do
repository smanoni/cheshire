...
WaveRestoreCursors {{Cursor 1} {2457390000 ps} 1} {{Cursor 2} {3123235000 ps} 1} {{Cursor 3} {2457570000 ps} 1} {{Cursor 4} {1668180000 ps} 1} {{Cursor 5} {399225573 ps} 0}
...
update
WaveRestoreZoom {7358464976 ps} {7358572191 ps}
